...
class RobotControl(object):
    ...
    def pubPosition(self, Mode, Position, wait=False):
        """

        :param Mode:  'Go' or 'Move'
        :param Position: if sixAxis: [x_mm, y_mm, z_mm, u_deg, v_deg, w_deg]
        :param wait: if waite robot reach the pos
        ...
        Com.command_to_robot(self.__ShmBuf, str.upper(Mode), Position, wait=wait)
    ...
    def pubAngle(self, Angle, wait=False):
        """
        ...
        Com.command_to_robot(self.__ShmBuf, "GO_DEG", Angle, wait=wait)
