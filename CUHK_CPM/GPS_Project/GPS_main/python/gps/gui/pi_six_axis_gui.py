...
class ControlPanel(wx.Frame):
    def __init__(self, parent, npzFileName):
        ...
        ####################call server ##########################    
        wx.StaticBox(self.pnl, label="I/O", pos=(695, 0), size=(100, 395))
        self.X1 = CheckBox(self.pnl, "X1", 700, 15, '/control_X1_State')
        self.X2 = CheckBox(self.pnl, "X2", 700, 45, '/control_X2_State')
        self.X3 = CheckBox(self.pnl, "X3", 700, 75, '/control_X3_State')
        self.X4 = CheckBox(self.pnl, "X4", 700, 105, '/control_X4_State')
        self.X5 = CheckBox(self.pnl, "X5", 700, 135, '/control_X5_State')
        self.X6 = CheckBox(self.pnl, "X6", 700, 165, '/control_X6_State')
        self.X7 = CheckBox(self.pnl, "X7", 700, 195, '/control_X7_State')
        self.X8 = CheckBox(self.pnl, "X8", 700, 225, '/control_X8_State')
        self.X9 = CheckBox(self.pnl, "X9", 700, 255, '/control_X9_State')
        self.X10 = CheckBox(self.pnl, "X10", 700, 285, '/control_X10_State')
        self.X11 = CheckBox(self.pnl, "X11", 700, 315, '/control_X11_State')
        self.X12 = CheckBox(self.pnl, "X12", 700, 345, '/control_X12_State')
        ...
        ##########################
        wx.StaticBox(self.pnl, label="Adjust coordinate(mm/deg)", pos=(490, 10), size=(200, 380))
        self.AdjustSetValueX = coordnate(self.pnl, "X:", 10.0, 70, -1, 520, 30)
        self.AdjustSetValueY = coordnate(self.pnl, "Y:", 10.0, 70, -1, 620, 30)
        self.AdjustSetValueZ = coordnate(self.pnl, "Z:", 10.0, 70, -1, 520, 60)
        self.AdjustSetValueU = coordnate(self.pnl, "U:", 10.0, 70, -1, 620, 60)
        self.AdjustSetValueV = coordnate(self.pnl, "V:", 10.0, 70, -1, 520, 90)
        self.AdjustSetValueW = coordnate(self.pnl, "W:", 10.0, 70, -1, 620, 90)
        ################X+X-Y+Y-Z+Z-U+U-V+V-U+U-W+W-###############
        self.XaddButton = wx.Button(self.pnl, -1, u'X+', size=(40, 40), pos=(540, 130))
        self.XaddButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnXadd, self.XaddButton)
        self.XdecButton = wx.Button(self.pnl, -1, u'X-', size=(40, 40), pos=(540, 200))
        self.XdecButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnXdec, self.XdecButton)
        self.YaddButton = wx.Button(self.pnl, -1, u'Y+', size=(40, 40), pos=(580, 165))
        self.YaddButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnYadd, self.YaddButton)
        self.YdecButton = wx.Button(self.pnl, -1, u'Y-', size=(40, 40), pos=(500, 165))
        self.YdecButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnYdec, self.YdecButton)
        self.ZaddButton = wx.Button(self.pnl, -1, u'Z+', size=(40, 40), pos=(630, 130))
        self.ZaddButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnZadd, self.ZaddButton)
        self.ZdecButton = wx.Button(self.pnl, -1, u'Z-', size=(40, 40), pos=(630, 200))
        self.ZdecButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnZdec, self.ZdecButton)
        self.UaddButton = wx.Button(self.pnl, -1, u'U+', size=(40, 40), pos=(510, 250))
        self.UaddButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnUadd, self.UaddButton)
        self.UdecButton = wx.Button(self.pnl, -1, u'U-', size=(40, 40), pos=(510, 300))
        self.UdecButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnUdec, self.UdecButton)
        self.VaddButton = wx.Button(self.pnl, -1, u'V+', size=(40, 40), pos=(570, 250))
        self.VaddButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnVadd, self.VaddButton)
        self.VdecButton = wx.Button(self.pnl, -1, u'V-', size=(40, 40), pos=(570, 300))
        self.VdecButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnVdec, self.VdecButton)
        self.WaddButton = wx.Button(self.pnl, -1, u'W+', size=(40, 40), pos=(630, 250))
        self.WaddButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnWadd, self.WaddButton)
        self.WdecButton = wx.Button(self.pnl, -1, u'W-', size=(40, 40), pos=(630, 300))
        self.WdecButton.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.BOLD, True))
        self.Bind(wx.EVT_BUTTON, self.OnWdec, self.WdecButton)
        ###############GO button#########################
        ...
        if len(self.key) == 1:
            if len(self.key) == 1 and ord(self.key) >= 48 and ord(self.key) <= 57 and len(self.key) == 1:
                if self.read_from_npz(self.npzFileName, "target" + self.key):
                    ...
                    self.J6_val.SetLabel(str(round(self.value[5], self.wei)))
                    self.joint_pos_deg[5] = self.value[5]
		    self.read_from_npz(self.npzFileName, "brick" + self.key)
                    self.Communication.Set_Object_Pos('hole', self.value)
                else:
                    self.Dis_npz_state.SetLabel("             This key is not exist!")
                    self.Dis_npz_state.SetForegroundColour("red")
    ...
    def OnSetTgtPts(self, event):
        ...
        if len(self.key) == 1:
            if ord(self.key) >= 48 and ord(self.key) < 57 and len(self.key) == 1:
                ...
                self.save_to_npz(self.npzFileName, "obs_tgt" + self.key, self.Communication.Get_position())
    ...
    def OnXadd(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0] + np.float64(self.AdjustSetValueX.get_coord_value())
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2]
        self.xyzuvw[3] = self.dispy_coord[3]
        self.xyzuvw[4] = self.dispy_coord[4]
        self.xyzuvw[5] = self.dispy_coord[5]
        self.Communication.Pub_Position(self.xyzuvw)

    def OnXdec(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0] - np.float64(self.AdjustSetValueX.get_coord_value())
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2]
    ...
    def OnYadd(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0]
        self.xyzuvw[1] = self.dispy_coord[1] + np.float64(self.AdjustSetValueY.get_coord_value())
        self.xyzuvw[2] = self.dispy_coord[2]
        self.xyzuvw[3] = self.dispy_coord[3]
        self.xyzuvw[4] = self.dispy_coord[4]
        self.xyzuvw[5] = self.dispy_coord[5]
    ...
    def OnZadd(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0]
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2] + np.float64(self.AdjustSetValueZ.get_coord_value())
        self.xyzuvw[3] = self.dispy_coord[3]
        self.xyzuvw[4] = self.dispy_coord[4]
        self.xyzuvw[5] = self.dispy_coord[5]
        self.Communication.Pub_Position(self.xyzuvw)

    def OnZdec(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0]
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2] - np.float64(self.AdjustSetValueZ.get_coord_value())
    ...
    def OnUadd(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0]
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2]
        self.xyzuvw[3] = self.dispy_coord[3] + np.float64(self.AdjustSetValueU.get_coord_value())
        self.xyzuvw[4] = self.dispy_coord[4]
        self.xyzuvw[5] = self.dispy_coord[5]
        self.Communication.Pub_Position(self.xyzuvw)

    def OnUdec(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0]
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2]
    ...
    def OnVadd(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0]
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2]
        self.xyzuvw[3] = self.dispy_coord[3]
        self.xyzuvw[4] = self.dispy_coord[4] + np.float64(self.AdjustSetValueV.get_coord_value())
        self.xyzuvw[5] = self.dispy_coord[5]
        self.Communication.Pub_Position(self.xyzuvw)

    def OnVdec(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0]
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2]
    ...
    def OnWadd(self, event):
        ...
        self.xyzuvw[3] = self.dispy_coord[3]
        self.xyzuvw[4] = self.dispy_coord[4]
        self.xyzuvw[5] = self.dispy_coord[5] + np.float64(self.AdjustSetValueW.get_coord_value())
        self.Communication.Pub_Position(self.xyzuvw)

    def OnWdec(self, event):
        self.time = time.time()
        self.xyzuvw[0] = self.dispy_coord[0]
        self.xyzuvw[1] = self.dispy_coord[1]
        self.xyzuvw[2] = self.dispy_coord[2]
    ...
    def onHome(self, event):
        ...
        ##update xyzuvw
        self.CoordSetValueX.txt.SetValue("418")
        self.CoordSetValueY.txt.SetValue("0")
        self.CoordSetValueZ.txt.SetValue("630")
        self.CoordSetValueU.txt.SetValue("180")
        self.CoordSetValueV.txt.SetValue("-90")
        self.CoordSetValueW.txt.SetValue("0")
    ...
    def DataUpdate(self, event):
        try:
            ...
            if self.ServerX1.Get_output():
                ...
                # self.Communication.Control_pneumatic_gripper(True)
            else:
                self.X1.SetForegroundColour("grey")
                # self.Communication.Control_pneumatic_gripper(False)
            ...
            if (time.time() - self.time) < 2:
                if abs(self.dispy_joint_vel[0]) > 0.1 or abs(self.dispy_joint_vel[1]) > 0.1 or abs(self.dispy_joint_vel[2]) \
                        > 0.1 or abs(self.dispy_joint_vel[3]) > 0.1 or abs(self.dispy_joint_vel[4]) > 0.1 or \
                                abs(self.dispy_joint_vel[5]) > 0.1:
                    self.XaddButton.Disable()
                    self.XdecButton.Disable()
                    self.YaddButton.Disable()
                    self.YdecButton.Disable()
                    self.ZdecButton.Disable()
                    self.ZaddButton.Disable()
                    self.UaddButton.Disable()
                    self.UdecButton.Disable()
                    self.VaddButton.Disable()
                    self.VdecButton.Disable()
                    self.WdecButton.Disable()
                    self.WaddButton.Disable()
                else:
                    self.XaddButton.Enable()
                    self.XdecButton.Enable()
                    self.YaddButton.Enable()
                    self.YdecButton.Enable()
                    self.ZaddButton.Enable()
                    self.ZdecButton.Enable()
                    self.UaddButton.Enable()
                    self.UdecButton.Enable()
                    self.VaddButton.Enable()
                    self.VdecButton.Enable()
                    self.WaddButton.Enable()
                    self.WdecButton.Enable()
            else:
                self.XaddButton.Enable()
                self.XdecButton.Enable()
                self.YaddButton.Enable()
