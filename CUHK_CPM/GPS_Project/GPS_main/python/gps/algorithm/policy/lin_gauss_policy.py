...
class LinearGaussianPolicy(Policy):
    ...
    def __init__(self, K, k, pol_covar, chol_pol_covar, inv_pol_covar):
        ...
        # zx, K.shape = (100, 4, 4)
        # zx, k.shape = (100, 4)
        # zx, pol_covar.shape = (100, 4, 4)
        # zx, chol_pol_covar.shape = (100, 4, 4)
        # zx, inv_pol_covar.shape = (100, 4, 4)
    ...
    def act(self, x, obs, meta, t, noise=None):
        ...
        Args:
            ...
            !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            important NOTE:
                    dimension of input x is (dX,), not (dX,1)
                dimension of output u is (dU,), not (dU,1)
        """
        # zx, self.K.shape = (100, 4, 4)
        # zx, x.shape = (4,)
        # zx, self.k.shape = (100, 4)
        print 'zx, enter act'
