...
_SAMPLETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOTAL_DATA_TYPES', index=16, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RR_COORD6D', index=17, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XPLUS', index=18, number=18,
      options=None,
      type=None),
  ],
