...
keyboard_bindings = {
    ...
    # keyboard binding for add/delete targets
    'atn': 'a',     # add target number
    'dtn': 'd',     # del target number
...
ps3_bindings = {
    ...
    #'collect': (PS3_BUTTON['rear_right_2'], PS3_BUTTON['action_circle']),
    #'fail'   : (PS3_BUTTON['rear_right_2'], PS3_BUTTON['action_cross']),
    #'test'   : (PS3_BUTTON['rear_right_2'], PS3_BUTTON['action_cross']),
...
config = {
    ...
    'figsize': (12, 12),
#    'image_topic': '/camera/rgb/image_color',
    'image_topic': '/wide_stereo/left/image_color',
