...
(cl:defmethod cl:initialize-instance :after ((m <Contact>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Contact)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rr_plugin-msg:<Contact> is deprecated: use rr_plugin-msg:Contact instead.")))

(cl:ensure-generic-function 'collision1-val :lambda-list '(m))
(cl:defmethod collision1-val ((m <Contact>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_plugin-msg:collision1-val is deprecated.  Use rr_plugin-msg:collision1 instead.")
  (collision1 m))

(cl:ensure-generic-function 'collision2-val :lambda-list '(m))
(cl:defmethod collision2-val ((m <Contact>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_plugin-msg:collision2-val is deprecated.  Use rr_plugin-msg:collision2 instead.")
  (collision2 m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Contact>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rr_plugin-msg:position-val is deprecated.  Use rr_plugin-msg:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Contact>)))
  ...
  "9bec28133dcd8eeab8695caed4e83ce8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Contact)))
  "Returns md5sum for a message object of type 'Contact"
  "9bec28133dcd8eeab8695caed4e83ce8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Contact>)))
  ...
  (cl:format cl:nil "string collision1~%string collision2~%geometry_msgs/Vector3[] position~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Contact)))
  "Returns full string definition for message of type 'Contact"
  (cl:format cl:nil "string collision1~%string collision2~%geometry_msgs/Vector3[] position~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
