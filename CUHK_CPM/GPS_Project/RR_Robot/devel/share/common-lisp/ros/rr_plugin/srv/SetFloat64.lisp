...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat64-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat64-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rr_plugin-srv:<SetFloat64-request> is deprecated: use rr_plugin-srv:SetFloat64-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat64-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat64-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rr_plugin-srv:<SetFloat64-response> is deprecated: use rr_plugin-srv:SetFloat64-response instead.")))
